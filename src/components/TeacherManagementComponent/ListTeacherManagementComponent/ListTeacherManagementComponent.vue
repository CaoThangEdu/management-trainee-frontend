          ...
          <div class="row card">
            ...
            >
              ...
              <div>
                ...
                <button
                  class="btn btn-instagram float-right btn-add-file"
                  @click="createFileTeacher"
                  title="Thêm file"
                >
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(item, index) in pageOfItems" :key="index">
                      ...
                      <td>{{ getNameFaculty(item.facultyId) }}</td>
                      <td>
                        <button
...
export default {
  ...
  methods: {
    ...
    getNameFaculty(facultyId){
      let facultiesById = CrudMixin.methods.convertArrayToObject(this.faculties, "id");
      if(facultyId in facultiesById) return facultiesById[facultyId].facultyName;
      return "";
    }
  },
};
