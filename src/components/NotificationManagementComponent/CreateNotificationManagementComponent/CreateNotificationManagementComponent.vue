        ...
        <div class="card-body">
          <form @submit.prevent>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8 col-sm-8">
                <SelectPlan
                  ...
                  @change="
                    (event) => {
                      notifyRequest.notificationDto.internshipCourseId = event.id;
                    }
                  "
                >
                </SelectPlan>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8 col-sm-8"
                :class="{'disable-wapper-content':checkInternshipCourseIdExist}">
            ...
            <div class="form-group row card">
              <div
                v-if="selectObject == notifyObjectEnum.ALL.value"
              >
              ...
              <div
                v-if="selectObject == notifyObjectEnum.TEACHERS.value">
                <div class="font-weight-bold text-center px-2 py-2">
                  Thông báo sẽ gửi đến tất cả giáo viên trong đợt thực tập
                </div>
              </div>
              <div
                v-if="selectObject == notifyObjectEnum.STUDENTS.value"
              >
                <div class="font-weight-bold text-center px-2 py-2">
              ...
              <div
                v-if="selectObject == notifyObjectEnum.CLASSID.value"
              >
              ...
              <div
                v-if="selectObject == notifyObjectEnum.EMAILTEACHERS.value"
              >
                <div class="font-weight-bold text-left px-2 py-2">
              ...
              <div
                v-if="selectObject == notifyObjectEnum.EMAILSTUDENTS.value"
              >
...
export default {
  ...
  methods: {
    ...
    validationNotifyRequest() {
      let objectEmailOrId = [this.notifyObjectEnum.CLASSID.value,
        this.notifyObjectEnum.EMAILTEACHERS.value, this.notifyObjectEnum.EMAILSTUDENTS.value];
      this.notifyRequest.groupOfPeople = objectEmailOrId.includes(this.selectObject)
        ?'':this.selectObject;
      if(!this.notifyRequest.groupOfPeople && this.notifyRequest.emails.length==0) {
    ...
    async getClassesFilterAsync() {
      this.filterClass.internshipCourseId = this.notifyRequest.notificationDto.internshipCourseId;
      // Call Api
      this.showLoading();
    ...
    async getStudentsAsync() {
      this.filterStudent.internshipCourseId = this.notifyRequest.notificationDto.internshipCourseId;
      // Call Api
      this.showLoading();
